            ...
            <div class="space-y-6">
                ...
                >
                    ...
                    <p class="text-muted-foreground">
                        Al habilitar la autenticación de dos factores, se te pedirá
                        un PIN seguro durante el inicio de sesión. Este PIN se obtiene
                ...
                >
                    ...
                    <p class="text-muted-foreground">
                        Con la autenticación de dos factores habilitada, se te pedirá
                        un PIN aleatorio y seguro durante el inicio de sesión, que
